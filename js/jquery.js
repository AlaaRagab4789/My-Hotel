...
$('.section-two,.header,.products1-head,.products1-read,.products2-read,.products3-read,.products4-read,.products2-head,.products3-head,.products4-head,.products5-head,.products6-head,.description,.section2222').css({marginTop: $('.navbar').innerHeight()});
