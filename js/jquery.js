...
$('.section-two,.header,.products1-head,.products1-read,.products2-read,.products3-read,.products4-read,.products2-head,.products3-head,.products4-head,.products5-head,.products6-head,.section2,.description').css({marginTop: $('.navbar').innerHeight()});
